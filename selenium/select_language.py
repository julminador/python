...
class LanguageOptions(unittest.TestCase):
    ...
    def test_sort_by(self):
        self.driver.find_element_by_xpath('/html/body/div/div[2]/header/div/div[3]/nav/ol/li[5]/a').click()
        exposed_options = ['Position', 'Name', 'Price']
        active_options = []
        sort_by = Select(self.driver.find_element_by_xpath('/html/body/div/div[2]/div[2]/div/div[2]/div[2]/div[3]/div[1]/div[1]/div/select'))  # Accede a las opciones del dropdown
